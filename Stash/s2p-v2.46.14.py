...
class SViewGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("S-View Created By Arthur Gu | V2.46.14")
    ...
    def setup_ui(self):
        ...
        tk.Button(chart_ops_group, text="Save Image", font=("sans-serif", 10, "bold"),
    ...
    def update_plots(self):
        ...
        if self.datasets:
            for dataset in self.datasets:
                ...
                legend_items[data_id] = {'label': f"{display_name}: Points: {data_points}", 'color': color}
