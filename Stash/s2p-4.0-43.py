...
class SViewGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("S-View Created By Arthur Gu | V4.0")
    ...
    def _handle_chart_output(self, copy=False):
        ...
        try:
            ...
            if self.display_mode.get() == "Max" and self.max_fig:
                ...
                self._draw_report_logo(target_fig, y_offset=logo_y_offset, x_offset=logo_x_offset, logo_width=logo_w, logo_height=logo_h)
            ...
            # ------------------- Normal 模式 -------------------
                ...
                normal_y_offset = 10
                normal_x_offset = 50
                self._draw_report_logo(out_fig, y_offset=normal_y_offset, x_offset=normal_x_offset, logo_width=normal_w, logo_height=normal_h)
                # ------------------------------------------------------------------------
