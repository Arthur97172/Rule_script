...
class SViewGUI:
    ...
    def setup_ui(self):
        ...
        tk.Button(load_reset_frame, text="Load Files", font=("sans-serif", 9, "bold"), 
                  bg="#4CAF50", fg="white", relief="raised", padx=1, pady=6, command=self.load_snp)\
        .pack(side="left", fill="x", expand=True, padx=(0, 2), pady=0)

        # Reset App 按钮 (保持在 load_reset_frame 的右侧)"#3F51B5"
        tk.Button(load_reset_frame, text="Reset App", font=("sans-serif", 9, "bold"), bg="#FF5722", fg="white", relief="raised", padx=1, pady=6, command=self.reset_application)\
        .pack(side="left", fill="x", expand=True, padx=(2, 0), pady=0)
