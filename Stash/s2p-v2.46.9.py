...
class SViewGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("S-View Created By Arthur Gu | V2.46.9")
    ...
    def setup_ui(self):
        ...
        # 使用 pack(fill="x", ...) 确保此 Frame 占据整个宽度，与 Load S2P File 按钮对齐
        clear_reset_frame.pack(fill="x", padx=5, pady=2) 

        # Clear Data 按钮：字体变小 (10 -> 9)，使用 side="left" 和 expand=True 实现水平排列和自动填充
        ...
        # Reset App 按钮：字体变小 (10 -> 9)，使用 side="left" 和 expand=True 实现水平排列和自动填充
