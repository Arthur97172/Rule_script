...
class SViewGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("S-View Created By Arthur Gu | V2.47.22")
...
# 文件: s2p-test1.py (在 SViewGUI 类内，替换 _setup_unified_y_control_ui 方法)
    ...
    def _draw_search_marker_frame(self, mark_data, container, plot_type, param):
        ...
        type_combo = ttk.Combobox(frame, textvariable=mark_data["search_type"], values=MARKER_SEARCH_TYPES, state="readonly", width=12)
