...
TESTING_OPS = [
    ...
    ("TDR on TMS (FINAL TEST)", 3.0, 90, 1, 'min', 'none'), # 0.9 -> 90
    ("PRESSURE TEST (Std)", 2.0, 100, 1, 'min', 'none'),
    ("PRESSURE TEST (IP Label)", 4.0, 100, 1, 'min', 'none'),    
...
class RoutingApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Routing Estimation Tool - V1.1 (Optimized 0-100%)")
