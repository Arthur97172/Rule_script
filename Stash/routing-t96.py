...
class RoutingApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Routing Estimation Tool - V1.0.9")
    ...
    def setup_ui(self):
        ...
        basic_outer.pack(fill='x', pady=(0, 5))
        ...
        run_outer.pack(fill='x', pady=(0, 5))
        ...
        comp_outer.pack(fill='x', pady=(0, 5))
